...
export const articleInputSchema = z.object({
  ...
  category: z.string().max(100).optional().default('Marketing Digital'),
  author: z.string().max(150).optional().default('Equipo AlmaMedia'),
  tags: z.union([z.array(z.string().max(50)), z.string().max(500)]).optional().default([]),
