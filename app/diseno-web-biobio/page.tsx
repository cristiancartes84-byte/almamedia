  ...
  return (
    <>
      ...
      <article className="relative z-10 max-w-4xl mx-auto px-8 py-12">
        ...
        <section id="por-que-web" className="mb-16">
          <h2 className="text-4xl font-black mb-6 text-[var(--color-accent)]">¿Por qué necesitas un sitio web profesional?</h2>
          ...
          <h3 className="text-2xl font-bold mb-4 mt-8">Beneficios de tener un sitio web profesional:</h3>
          <ul className="space-y-3 mt-6">
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Credibilidad instantánea:</strong> Un sitio profesional transmite confianza y seriedad</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Ventas 24/7:</strong> Tu negocio trabaja mientras duermes</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Alcance ilimitado:</strong> Llegas a clientes en toda la región del Biobío</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Menor costo que publicidad tradicional:</strong> ROI superior a largo plazo</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Datos y métricas:</strong> Sabes exactamente qué funciona y qué no</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Escalabilidad:</strong> Crece al ritmo de tu negocio</li>
          </ul>
        </section>

        {/* Qué incluye */}
        <section id="que-incluye" className="mb-16">
          <h2 className="text-4xl font-black mb-6 text-[var(--color-accent)]">¿Qué incluye nuestro diseño web?</h2>
        ...
        <section id="proceso" className="mb-16">
          <h2 className="text-4xl font-black mb-6 text-[var(--color-accent)]">Nuestro Proceso de Diseño Web</h2>
          <p className="text-lg mb-8 leading-relaxed">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold mb-3">Paso 1: Descubrimiento (Semana 1)</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">Paso 2: Diseño (Semana 2)</h3>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">Paso 3: Desarrollo (Semana 3-4)</h3>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">Paso 4: Contenido + SEO (Semana 4)</h3>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">Paso 5: Lanzamiento (Semana 5)</h3>
              <p className="text-lg leading-relaxed">
        ...
        <section id="tecnologias" className="mb-16">
          <h2 className="text-4xl font-black mb-6 text-[var(--color-accent)]">Tecnologías que Usamos</h2>
          <p className="text-lg mb-6 leading-relaxed">
          ...
          <h3 className="text-2xl font-bold mb-4 mt-8">¿Por qué WordPress?</h3>
          <ul className="space-y-3 mt-6">
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Flexible y escalable:</strong> Desde landing page simple hasta ecommerce complejo</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Fácil de usar:</strong> Puedes editar contenido sin saber programar</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">SEO-friendly:</strong> Excelente para posicionamiento en Google</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Miles de plugins:</strong> Funcionalidades adicionales cuando las necesites</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Comunidad enorme:</strong> Soporte y recursos ilimitados</li>
          </ul>

          <h3 className="text-2xl font-bold mb-4 mt-8">También trabajamos con:</h3>
          <ul className="space-y-3 mt-6">
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Shopify:</strong> Para ecommerce que necesitan empezar a vender rápido</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">HTML/CSS puro:</strong> Para landing pages ultra-rápidas</li>
          </ul>

          <p className="text-[var(--color-muted)] mt-6 italic">
        ...
        <section id="precios" className="mb-16">
          <h2 className="text-4xl font-black mb-6 text-[var(--color-accent)]">Precios de Diseño Web en Biobío</h2>
          <p className="text-lg mb-8 leading-relaxed">
        ...
        <section id="garantia" className="mb-16">
          <h2 className="text-4xl font-black mb-6 text-[var(--color-accent)]">Nuestra Garantía</h2>
          <p className="text-lg mb-6 leading-relaxed">
            Estamos tan seguros de la calidad de nuestro trabajo que ofrecemos:
          </p>

          <ul className="space-y-3">
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">1 mes de soporte post-lanzamiento:</strong> Cualquier ajuste o corrección sin costo</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Garantía de velocidad:</strong> Si tu sitio carga en más de 3 segundos, lo optimizamos gratis</li>
            <li className="leading-relaxed"><strong className="text-[var(--color-accent)] font-bold">Revisiones ilimitadas:</strong> Durante la etapa de diseño, ajustamos hasta que estés 100% satisfecho</li>
          </ul>
        </section>

        {/* FAQ */}
        <section id="faq" className="mb-16">
          <h2 className="text-4xl font-black mb-6 text-[var(--color-accent)]">Preguntas Frecuentes</h2>

          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold mb-3">¿Cuánto tarda en estar listo mi sitio web?</h3>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">¿Puedo actualizar el sitio yo mismo después?</h3>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">¿El hosting y dominio están incluidos?</h3>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">¿Qué pasa si quiero agregar funcionalidades después?</h3>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-3">¿Trabajan con negocios de toda la región del Biobío?</h3>
              <p className="text-lg leading-relaxed">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 mb-20">
        <div className="bg-[var(--color-card)] border border-[var(--color-border)] rounded-2xl p-16 text-center">
          <h2 className="text-4xl font-black mb-4">¿Listo para lanzar tu sitio web?</h2>
