...
export const metadata = {
  title: 'Diseño Web en San Pedro de la Paz - Alma Media',
  description: 'Diseño web profesional en San Pedro de la Paz. Sitios WordPress optimizados.',
};
  ...
  return (
    <>
      ...
      <article className="relative z-10 max-w-4xl mx-auto px-8 py-24">
        ...
        <h1 className="text-5xl font-black mb-6">Diseño Web en San Pedro de la Paz</h1>
        <p className="text-xl text-[var(--color-muted)] mb-12">Sitios web para empresas en San Pedro de la Paz, Biobío.</p>
