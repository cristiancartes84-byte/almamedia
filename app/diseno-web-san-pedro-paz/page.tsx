...
export const metadata: Metadata = {
  title: `Diseño Web San Pedro de la Paz ${currentYear} | Sitios Profesionales`,
  description: 'Diseño web profesional en San Pedro de la Paz. Especializados en negocios locales, educación, salud y servicios. Desde $199.000/año. Cotiza gratis.',
  ...
  twitter: {
    ...
    title: `Diseño Web San Pedro de la Paz ${currentYear}`,
  ...
  return (
    <>
      ...
      <article className="relative z-10 max-w-4xl mx-auto px-8 py-12">
        ...
        {/* Precios */}
        <section className="mb-20">
          <h2 className="text-4xl font-black mb-8 text-[var(--color-accent)] text-center">Precios Diseño Web en San Pedro</h2>
          <p className="text-xl mb-10 leading-[1.8] text-center max-w-3xl mx-auto text-justify">
            Precios transparentes para negocios locales de San Pedro de la Paz. Sin sorpresas ni costos ocultos:
          </p>
