...
export const metadata: Metadata = {
  title: `Diseño Web Coronel ${currentYear} | Sitios WordPress Profesionales desde $199.000`,
  ...
  openGraph: {
    title: `Diseño Web Coronel ${currentYear} | Sitios WordPress Profesionales`,
  ...
  twitter: {
    ...
    title: `Diseño Web Coronel ${currentYear}`,
