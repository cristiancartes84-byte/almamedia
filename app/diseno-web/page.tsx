    ...
    <>
      ...
      <article className="relative z-10 max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-8">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <span className="text-[var(--color-muted)]">Llegas a clientes en todo Chile</span>
              </div>
            </div>
        ...
        <section id="que-incluye" className="mb-20">
          ...
          <p className="text-xl mb-10 leading-[1.9] text-center max-w-3xl mx-auto">
        ...
        <section id="proceso" className="mb-20">
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="text-lg leading-[1.8] text-center max-w-3xl mx-auto">
        ...
        <section id="precios" className="mb-20">
          <h2 className="text-4xl font-black mb-8 text-[var(--color-accent)] text-center">Precios de Diseño Web</h2>
          <p className="text-xl mb-10 leading-[1.9] text-center max-w-3xl mx-auto">
