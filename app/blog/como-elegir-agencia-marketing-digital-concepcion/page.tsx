      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 pt-8">
        ...
        <article className="relative z-10 py-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h2 className="text-3xl font-black mb-6 mt-12 text-[var(--color-accent)]">Tamaño de Agencia: ¿Grande, Mediana o Pequeña?</h2>
              ...
              <table className="w-full text-sm border-collapse not-prose">
                <thead>
                  <tr className="border-b-2 border-[var(--color-accent)]">
                    ...
                    <th className="text-center p-4">Ventajas</th>
                    <th className="text-center p-4">Desventajas</th>
                    <th className="text-center p-4">Ideal Para</th>
                  </tr>
                </thead>
                <tbody className="text-[var(--color-muted)]">
                  <tr className="border-b border-[var(--color-border)]">
                    <td className="p-4 font-bold">Grande (20+)</td>
                    <td className="p-4">Recursos amplios, especialistas, proceso establecido</td>
                    <td className="p-4">Menos atención personal, más caro, procesos lentos</td>
                    <td className="p-4">Empresas grandes, presupuesto $2M+/año</td>
                  </tr>
                  <tr className="border-b border-[var(--color-border)]">
                    <td className="p-4 font-bold">Mediana (5-20)</td>
                    <td className="p-4">Balance atención/recursos, flexible, precio razonable</td>
                    <td className="p-4">Capacidad limitada vs grandes</td>
                    <td className="p-4">PYMES, presupuesto $300k-$2M/año</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-bold">Pequeña (1-5)</td>
                    <td className="p-4">Atención personalizada, ágil, más económica</td>
                    <td className="p-4">Capacidad limitada, menos especialización</td>
                    <td className="p-4">Pequeños negocios, presupuesto <$300k/año</td>
                  </tr>
                </tbody>
              </table>
            </div>
